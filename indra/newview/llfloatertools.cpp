...
{	
	...
	mCheckManipPivotAtRoot	= getChild<LLCheckBoxCtrl>("checkbox actual root");
...
void LLFloaterTools::updatePopup(LLCoordGL center, MASK mask)
{
	...
	if (mCheckManipPivotAtRoot) mCheckManipPivotAtRoot->setVisible( edit_visible );
